const API_KEY =
  '60c1112f70bc2b02e9583cf8115e9f1260362b37bf5bd0649c11f595e81ac283';
...
function libsRender() {
  ...
  for (let i = 0; i < 5; i++) {
    ...
    <i class="fa-solid fa-book"></i><a href="#" onclick="mapChangeLocation(${
      libList[i].lib.latitude
    },${libList[i].lib.longitude})">${libList[i].lib.libName}</a></div>
    <div class="info">
      <dl>
      <div>
...
const mapChangeLocation = (newLat, newLng) => {
  let moveLatLon = new kakao.maps.LatLng(newLat, newLng);
